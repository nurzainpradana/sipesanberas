  ...
  <body class="goto-here">
    ...
    <section class="ftco-section ftco-choose ftco-no-pb ftco-no-pt">
    	<div class="container">
				<div class="row no-gutters">
					<div class="col-lg-4">
						<div class="choose-wrap divider-one img p-5 d-flex align-items-end" style="background-image: <?php echo base_url().'assets/images/choose-1.jpg'?>;">
    				...
    				<div class="row no-gutters choose-wrap divider-two align-items-stretch">
    					<div class="col-md-12">
	    					<div class="choose-wrap full-wrap img align-self-stretch d-flex align-item-center justify-content-end" style="background-image: <?php echo base_url().'assets/images/choose-2.jpg'?>;">
    ...
    <section class="ftco-section ftco-deal bg-primary">
    	<div class="container">
    		<div class="row">
    			<div class="col-md-6">
    				<img src="<?php echo base_url().'assets/images/prod-1.png'?>" class="img-fluid" alt="">
    			</div>
    			<div class="col-md-6">
    				...
    				<div id="timer" class="d-flex mb-4">
						...
						<div class="text-deal">
							...
							<ul class="thumb-deal d-flex mt-4">
								<li class="img" style="background-image: <?php echo base_url().'assets/images/product-6.png'?>);"></li>
								<li class="img" style="background-image: <?php echo base_url().'assets/images/product-2.png'?>);"></li>
								<li class="img" style="background-image: <?php echo base_url().'assets/images/product-4.png'?>);"></li>
							</ul>
						</div>
    			</div>
    		</div>
            ...
            <div class="carousel-testimony owl-carousel">
              <div class="item">
                <div class="testimony-wrap">
                  <div class="user-img mb-4" style="background-image: <?php echo base_url().'assets/images/person_1.jpg'?>">
              ...
              <div class="item">
                <div class="testimony-wrap">
                  <div class="user-img mb-4" style="background-image: <?php echo base_url().'assets/images/person_2.jpg'?>">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
              ...
              <div class="item">
                <div class="testimony-wrap">
                  <div class="user-img mb-4" style="background-image: <?php echo base_url().'assets/images/person_3.jpg'?>">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
    ...
    <section class="ftco-gallery">
    	...
    	<div class="container-fluid px-0">
    		<div class="row no-gutters">
					...
					<div class="col-md-4 col-lg-2 ftco-animate">
						<a href="<?php echo base_url().'assets/images/gallery-6.jpg'?>" class="gallery image-popup img d-flex align-items-center" style="background-image: <?php echo base_url().'assets/images/gallery-6.jpg'?>;">
							<div class="icon mb-4 d-flex align-items-center justify-content-center">
    						<span class="icon-instagram"></span>
    					</div>
						</a>
